...
public class PlayerHealth : MonoBehaviour, IDamageable, IResettable
{
    ...
    void Awake()
    {
        ...
        // ── HUD PATCH: initial HUD sync
        GameEvents.FireHealthChanged((int)CurrentHealth, (int)maxHealth);
    }
    ...
    // ── HUD PATCH: compatibility with CheckpointManager
    public void RestoreHealth(float savedHealth) => SetHealth(savedHealth);
    ...
    // ── HUD PATCH: required by IResettable
