       ...
       private void HandleCrouch()
{
    ...
    _controller.height = Mathf.Lerp(_controller.height, targetHeight,
                                    Time.deltaTime * CrouchTransitionSpeed);
    _controller.center = Vector3.Lerp(_controller.center, targetCenter,
                                    Time.deltaTime * CrouchTransitionSpeed);

    Vector3 targetCameraPos = _isCrouching
        ? new Vector3(_standingCameraTargetLocalPos.x,
                      CrouchCameraTargetY,
                      _standingCameraTargetLocalPos.z)
